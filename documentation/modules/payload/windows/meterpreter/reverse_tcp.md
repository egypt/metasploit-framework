`windows/meterpreter/reverse_tcp` is one of the most powerful features
...
The `shell` command allows you to interact with the remote machine's
...
To find the source of the method, you can use the `#source_location`
